...
The broader lesson is that the npm ecosystem's design philosophy of maximizing composability and minimizing friction creates structural incentives that benefit attackers. Any serious supply chain defense must grapple with this, and this paper is one of the clearest articulations of where the detection leverage points are.
