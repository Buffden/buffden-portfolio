  ...
  template: `
    <div class="social-sidebar">
      <ul class="social-list">
        ...
        <li>
          <a href="https://medium.com/@buffden" aria-label="Medium" target="_blank" rel="noreferrer">
        ...
        <li>
          <a href="https://www.npmjs.com/~buffden" aria-label="npm" target="_blank" rel="noreferrer">
