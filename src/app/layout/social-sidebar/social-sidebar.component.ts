  ...
  template: `
    <div class="social-sidebar">
      <ul class="social-list">
        <li>
          <a href="https://github.com/buffden" aria-label="GitHub" target="_blank" rel="noreferrer" (click)="trackSocial('GitHub')">
        ...
        <li>
          <a href="https://www.linkedin.com/in/harshwardhanpatil23" aria-label="LinkedIn" target="_blank" rel="noreferrer" (click)="trackSocial('LinkedIn')">
        ...
        <li>
          <a href="https://medium.com/@buffden" aria-label="Medium" target="_blank" rel="noreferrer" (click)="trackSocial('Medium')">
            <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather">
              <title>Medium</title>
              <path d="M2 4h3l7 12 7-12h3v16h-2.5V9l-5.5 9.5h-2L7 9v11H2V4z"/>
            </svg>
          </a>
        </li>
        <li>
          <a href="https://www.npmjs.com/~buffden" aria-label="npm" target="_blank" rel="noreferrer" (click)="trackSocial('npm')">
            <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="currentColor" stroke="none" class="feather">
              <title>npm</title>
        ...
        <li>
          <a href="https://leetcode.com/buffden" aria-label="LeetCode" target="_blank" rel="noreferrer" (click)="trackSocial('LeetCode')">
            <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather">
        ...
        <li>
          <a href="https://stackoverflow.com/users/14113753/buffden" aria-label="Stack Overflow" target="_blank" rel="noreferrer" (click)="trackSocial('StackOverflow')">
            <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather">
        ...
        <li>
          <a href="https://huggingface.co/buffden" aria-label="Hugging Face" target="_blank" rel="noreferrer" (click)="trackSocial('HuggingFace')">
            <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather">
...
export class SocialSidebarComponent {
  ...
  trackSocial(platform: string): void {
    this.analytics.trackEvent('social_click', { platform, source: 'sidebar' });
  }
}
