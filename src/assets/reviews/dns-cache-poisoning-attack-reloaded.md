...
One thing I really liked is the depth of experimentation. The authors didn’t just propose theoretical attacks; they demonstrated them in realistic environments. This strengthens the credibility of their claims. However, I felt that some of the attack explanations, especially around side-channel exploitation, were quite dense and required careful reading. A simplified diagram or step-by-step example would have made it easier to follow.
...
One surprising aspect was how seemingly minor protocol behaviors (like IP fragmentation) can undermine major security assumptions. This contradicts the expectation that modern systems are robust against such low-level exploitation. Overall, the paper is technically strong but could benefit from clearer explanations for readers who are not deeply familiar with DNS internals.